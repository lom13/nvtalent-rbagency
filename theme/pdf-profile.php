...
if(strpos(get_site_url(),'localhost') !== false){
	...
	$rb_agency_option_agencylogo = !empty($rb_agency_options_arr['rb_agency_option_agencylogo']) ? get_site_url().$rb_agency_options_arr['rb_agency_option_agencylogo'] : RBAGENCY_PLUGIN_URL."assets/img/logo_example.jpg";
}
...
//$rb_agency_option_agencylogo = "/wp-content/plugins/rb-agency/assets/img/logo_example.jpg";
	...
	$modelInfo=str_replace("</label>","</label>:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;",$modelInfo);
		...
		elseif(!empty($orderBy)) {
			...
			//$allImages.="<td><img id='".$dataImg["ProfileMediaID"]."' src=\"".get_bloginfo("url")."/wp-content/plugins/rb-agency/ext/timthumb.php?src=". RBAGENCY_UPLOADDIR . $ProfileGallery ."/". $dataImg['ProfileMediaURL']  .$timthumbHW."\" alt='' class='allimages_thumbs' /></td>\n";
				...
				$allImages.= "<td valign='top'><img src=\"".$imgURL."\" alt='x' class='allimages_thumbs' ".$imgStyle." id='".$dataImg["ProfileMediaID"]."'/></td>\n";
